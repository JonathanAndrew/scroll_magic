$(document).ready(function(){
    ...
    .add(TweenMax.to('#scroll ',400,{transform:'rotation(+=3600)',transform:"translate(400px,400px)", ease:Linear.easeNone}))
    ...
    .add(TweenMax.to('#scroll',400,{transform:"translate(-100px,2000px)",ease:Linear.easeNone,delay:200}))
